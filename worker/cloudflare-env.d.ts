/* eslint-disable */
// Generated by Wrangler by running `wrangler types --cwd worker --env-interface CloudflareEnv cloudflare-env.d.ts` (hash: ba2f173046bfba080235bdb82d2cba9f)
